...
export function RoomView3D({ room, fixtures, selectedIndex, palette = {}, showcase = false }: Props) {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label={`Angled view of the bathroom with ${fixtures.length} fixtures`}
    >
      <defs>
